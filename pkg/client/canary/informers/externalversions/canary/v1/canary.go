...
import (
	...
	versioned "github.com/iyacontrol/shareit/pkg/client/canary/clientset/versioned"
	internalinterfaces "github.com/iyacontrol/shareit/pkg/client/canary/informers/externalversions/internalinterfaces"
	v1 "github.com/iyacontrol/shareit/pkg/client/canary/listers/canary/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.CanaryV1().Canaries(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CanaryV1().Canaries(namespace).Watch(options)
			},
		},
		&canaryv1.Canary{},
		resyncPeriod,
...
func (f *canaryInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&canaryv1.Canary{}, f.defaultInformer)
}
