...
import (
	...
	scheme "github.com/iyacontrol/shareit/pkg/client/cronhpa/clientset/versioned/scheme"
...
func newCronHpas(c *CronhpaV1Client, namespace string) *cronHpas {
	return &cronHpas{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *cronHpas) DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error {
	var timeout time.Duration
